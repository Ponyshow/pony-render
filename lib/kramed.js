 ...
 * https://github.com/GitbookIO/kramed
 *
 * kramed-ponyshow - a kramdown parser for ponyshow tokens
 * Copyright (c) 2015, TZ Martin (MIT Licensed)
 * https://github.com/semanticpress/kramed-ponyshow
*/
...
Parser.prototype.tok = function() {
  ...
  switch (this.token.type) {
    ...
    case 'hr': {
      return this.renderer.hr(this.token.class,this.token.id);
    }
    case 'heading': {
...
function kramed(src, opt, callback) {
  ...
  try {
    ...
    e.message += '\nPlease report this to https://github.com/semanticpress/pony-render.';
