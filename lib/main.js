        ...
        for(var x=0;x<arr.length;x++) {
          ...
          switch(opts[0]) {
            ...
            case 'slidenumbers':
              ...
              self.log(':::::::'+Renderer.options.slidenumbers);
              break;
...
Pony.prototype.render = function(dat,opts) {
  ...
  if (LEXED.length == 0) {
    LEXED = "<div style=\"margin-top:40px;\"><img src='http://ifttt.com/assets/r2012/404_unicorn-b2f39d73d46465d5619060c8406b410b.svg' alt='sleeping pony' /><br>Pony parser failed.</div>";
  }
